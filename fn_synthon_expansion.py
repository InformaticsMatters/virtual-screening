...
def main():
    ...
    parser.add_argument('--hac-min', type=int, help='The min heavy atom count')
    parser.add_argument('--hac-max', type=int, help='The max heavy atom count')
    parser.add_argument('--rac-min', type=int, help='The min ring atom count')
    parser.add_argument('--rac-max', type=int, help='The max ring atom count')
