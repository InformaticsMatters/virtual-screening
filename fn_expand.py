...
def main():
    ...
    parser.add_argument('--hac-min', type=int, help='Permitted reduction in heavy atom count')
    parser.add_argument('--hac-max', type=int, help='Permitted increase in heavy atom count')
    parser.add_argument('--rac-min', type=int, help='Permitted reduction in ring atom count')
    parser.add_argument('--rac-max', type=int, help='Permitted increase in ring atom count')
