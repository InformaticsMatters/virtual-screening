...
Typically this job uses the output of the [moldb-extract-molecules](../moldb/moldb-extract-molecules.md) job as its input.
...
* Job definition: `jobs.max-min-picker` in [rdkit.yaml](/data-manager/rdkit.yaml)
